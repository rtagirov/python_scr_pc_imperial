...
# temperature C
z_c_full = np.loadtxt(paths.it0h + 'conv_icl/c_full/FAL_VD',   usecols = [0])
T_c_full = np.loadtxt(paths.it0h + 'conv_icl/c_full/FAL_VD',   usecols = [1])

z_c_utmi = np.loadtxt(paths.it0h + 'conv_icl/c_utmi/FAL_VD',   usecols = [0])
...
# temperature S
z_s_full = np.loadtxt(paths.it0h + 'conv_icl/s_full/FAL_VD',   usecols = [0])
T_s_full = np.loadtxt(paths.it0h + 'conv_icl/s_full/FAL_VD',   usecols = [1])

z_s_utmi = np.loadtxt(paths.it0h + 'conv_icl/s_utmi/FAL_VD',   usecols = [0])
T_s_utmi = np.loadtxt(paths.it0h + 'conv_icl/s_utmi/FAL_VD',   usecols = [1])

# convergence S
i_s_full = np.loadtxt(paths.it0h + 'conv_icl/s_full/CONV/ALL', skiprows = 2, usecols = [0])
c_s_full = np.loadtxt(paths.it0h + 'conv_icl/s_full/CONV/ALL', skiprows = 2, usecols = [4])

i_s_utmi = np.loadtxt(paths.it0h + 'conv_icl/s_utmi/CONV/ALL', skiprows = 2, usecols = [0])
c_s_utmi = np.loadtxt(paths.it0h + 'conv_icl/s_utmi/CONV/ALL', skiprows = 2, usecols = [4])

# temperature Kurucz
z_k = np.loadtxt(paths.it0h + 'conv_icl/k/kur_atm', skiprows = 7, usecols = [2])
T_k = np.loadtxt(paths.it0h + 'conv_icl/k/kur_atm', skiprows = 7, usecols = [7])

# convergence Kurucz
i_k = np.loadtxt(paths.it0h + 'conv_icl/k/CONV/ALL', skiprows = 2, usecols = [0])
c_k = np.loadtxt(paths.it0h + 'conv_icl/k/CONV/ALL', skiprows = 2, usecols = [4])
...
pltaux.savepdf(paths.figdir, 'conv_icl')
