...
fig.suptitle('Continuum grid timing', y = 1.01)
...
ax[0].plot(w, f5, label = '(07m 45s) nlte 11, cont 10, conv 3',   color = 'purple', linewidth = 0.25)
ax[0].plot(w, f6, label = '(07m 48s) nlte 11, cont 5/20, conv 3', color = 'orange', linewidth = 0.25)
ax[0].plot(w, f7, label = '(06m 46s) nlte 11, cont 20, conv 3',   color = 'cyan',   linewidth = 0.25)
...
ax[1].plot(w, f1 / f7, color = 'cyan',   linewidth = 0.5)
...
auxplt.savepdf('runtime_spec_comp_cont_3')
