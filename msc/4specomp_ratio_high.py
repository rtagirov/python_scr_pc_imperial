...
wvl, flu2 = nessy.read_spec(paths.it1f + 'runtime/nlte11/',                   wvl1 = 1005, wvl2 = 10000)
wvl, flu3 = nessy.read_spec(paths.it1f + 'runtime/nlte11_fgrid_red_5/',       wvl1 = 1005, wvl2 = 10000)
wvl, flu4 = nessy.read_spec(paths.it1f + 'runtime/nlte11_fgrid_red_5_eps_3/', wvl1 = 1005, wvl2 = 10000)
...
outname = 'runtime_specomp'

np.savez(paths.npz + outname, w = wvls, f1 = flus1, f2 = flus2, f3 = flus3, f4 = flus4)
#np.savez(paths.npz + outname, w = wvl, f1 = flu1, f2 = flu2, f3 = flu3, f4 = flu4)
...
ax[0].plot(w, f3, label = '(12m 24s) nlte 11, cont 5',         color = 'r', linewidth = 0.5)
...
leg = ax[0].legend(framealpha = 1, loc = 4, handletextpad = 1, prop = {'size':7.5})

for obj in leg.legendHandles:

    obj.set_linewidth(3.0)

auxplt.savepdf('runtime_spec_comp')
