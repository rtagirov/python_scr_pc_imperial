...
ax.plot(w, f1 / f2, color = 'b',      label = '(24m 15s) nlte 11',                 linewidth = 1)
ax.plot(w, f1 / f3, color = 'r',      label = '(12m 24s) nlte 11, cont 5, conv 4', linewidth = 1)
ax.plot(w, f1 / f4, color = 'g',      label = '(10m 32s) nlte 11, cont 5, conv 3', linewidth = 0.5)
ax.plot(w, f1 / f5, color = 'purple', label = '(07m 19s) nlte 11, cont 5, conv 2', linewidth = 0.5)
ax.plot(w, f1 / f6, color = 'orange', label = '(05m 22s) nlte 11, cont 5, conv 1', linewidth = 0.5)
...
auxplt.savepdf('runtime_spec_comp_conv_1p')
